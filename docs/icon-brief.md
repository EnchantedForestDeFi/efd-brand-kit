...
EnchantedForestDeFi night theme — exact dark hex TBD).
...
- [ ] Wallet has been rebuilt locally and the new icon confirmed in:
      window title bar, taskbar/dock, About dialog, and Windows installer
